...
public class Moniteur extends Plongeur {
    ...
    public Optional<Club> employeurActuel() throws Exception {
         if (lesEmbauches.isEmpty()) throw new Exception("Aucun emploi");
         
         if (lesEmbauches.get(lesEmbauches.size()-1).estTerminee()) throw new Exception("Dernier emploi terminé");
